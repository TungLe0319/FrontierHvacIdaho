      ...
      <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
          <div class="relative">
              ...
              <div class="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
                  <h1 class="text-center text-6xl font-serif font-bold text-gray-800 dark:text-white ">Get Started now
                  </h1>
                  ...
                  <div class="flex flex-wrap justify-center gap-6">
                   <Button class=" rounded-full  bg-[var(--auburn)]  text-white shadow-md  items-center justify-center  mb-4 text-3xl">
